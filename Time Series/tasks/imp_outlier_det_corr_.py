#TEST DATA IMPUTATION, OUTLIER DETECTION E CORRECTION
...
def save_results(od_method, oc_method, imp_method, percentage, r2):
    path = "../Risultati/NEWeather/rf_classification_mix_none_outliers_1.csv"
...
imputation_methods = ['interpolation','mean']
ws = 1008
slide = 144
percentage = 10
