...
def main():
    ...
    file = open("KB_single_columns_three_prova.csv", "w")
    file_scores = open("KB_single_columns_three_all_scores_prova.csv", "w")
    ...
    for dataset_name in datasets:
        ...
        for column in columns:
            ...
            for ML_model in ML_models:
                ...
                file_scores.write(dataset_name + "," + column + "," + ML_model + "," + str(scores) + "\n")
                ...
                for i in range(0, len(feature_list)):
                    file.write(dataset_name + "," + column + "," + feature_list[i] + "," + ML_model + "," +
